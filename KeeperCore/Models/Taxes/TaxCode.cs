...
namespace KeeperCore.ERPNode.Models.Taxes
{
    ...
    public class TaxCode
    {
        ...
        public virtual ChartOfAccount.AccountItem TaxAccount { get; set; }

        public Guid? OutputTaxAccountId { get; set; }
        [ForeignKey("OutputTaxAccountId")]
        public virtual ChartOfAccount.AccountItem OutputTaxAccount { get; set; }


        public Guid? InputTaxAccountId { get; set; }
        [ForeignKey("InputTaxAccountId")]
        public virtual ChartOfAccount.AccountItem InputTaxAccount { get; set; }


        public Guid? AssignAccountId { get; set; }
        [ForeignKey("AssignAccountId")]
        public virtual ChartOfAccount.AccountItem AssignAccount { get; set; }


        public Guid? CloseToAccountId { get; set; }
        [ForeignKey("CloseToAccountId")]
        public virtual ChartOfAccount.AccountItem CloseToAccount { get; set; }
     ...
     //   public virtual ICollection<Transactions.Commercial> Commercials { get; set; }
        ...
        public virtual ChartOfAccount.AccountItem TaxPayableAccount { get; set; }
