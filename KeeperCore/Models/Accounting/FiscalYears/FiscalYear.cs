...
namespace KeeperCore.ERPNode.Models.Accounting
{
    ...
    public class FiscalYear
    {
        ...
        internal PeriodAccountBalance CreateFiscalBalanceLine(AccountItem account)
        {
        ...
        internal void UpdateOpeningFiscalBalance(AccountItem account, decimal debit, decimal credit)
        {
        ...
        internal void UpdateCurrentFiscalBalance(AccountItem account, decimal debit, decimal credit)
        {
            var accBalanceLine = this.PeriodAccountBalances.Where(l => l.AccountId == account.Id).FirstOrDefault();
        ...
        internal void UpdateClosingFiscalBalance(AccountItem account, decimal debit, decimal credit)
        {
            var accBalanceLine = this.PeriodAccountBalances.Where(l => l.AccountId == account.Id).FirstOrDefault();
