...
namespace KeeperCore.ERPNode.Models.Items
{
    ...
    public partial class Item
    {
        ...
        public virtual ICollection<Transactions.TransactionItem> CommercialItems { get; set; }
        ...
        public virtual ICollection<AssistItem> AssistItems { get; set; }
        ...
        public string GetQuickFinderValue => QuickFinderValue ?? Brand?.Name;
        public DateTime? CreatedDate { get; set; }
        public void AddImage(byte[] toPutInDb)
        {
            var itemImage = new KeeperCore.ERPNode.Models.Items.ItemImage()
            {
                Id = Guid.NewGuid(),
                ItemId = Id,
                Image = toPutInDb
