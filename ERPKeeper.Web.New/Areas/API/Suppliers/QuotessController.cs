...
{
    public class QuotesController : API_Suppliers_BaseController
    {
        public object All(DataSourceLoadOptions loadOptions)
        {
            var returnModel = Organization.ErpCOREDBContext.Purchases
                .Where(x => x.Status == ERPKeeperCore.Enterprise.Models.Suppliers.Enums.PurchaseStatus.Quote)
                .ToList();
        ...
        public IActionResult Insert(string values)
        {
            ...
            model.Status = ERPKeeperCore.Enterprise.Models.Suppliers.Enums.PurchaseStatus.Quote;
