...
using ERPKeeperCore.Web.Areas.API.Profiles.Employees;
using ERPKeeperCore.Web.Areas.API.Profiles.Employees.EmployeePaymentType;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;
using Newtonsoft.Json;

namespace ERPKeeperCore.Web.Areas.API.Employees.EmployeePaymentType
{
