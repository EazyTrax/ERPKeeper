...
ko.utils.domNodeDisposal = new (function () {
    ...
    function cleanSingleNode(node) {
        ...
        // Many jQuery plugins (including jid.tmpl) store data using jQuery's equivalent of domData
        // so notify it to tear down any resources associated with the node & descendants here.
        if ((typeof jid == "function") && (typeof jQuery['cleanData'] == "function"))
...
(function () {
    ...
    ko.bindingContext = function(dataItemOrAccessor, parentContext, dataItemAlias, extendCallback) {
        ...
        // The binding context object includes static properties for the current, parent, and root view ERPKeeper.Node.Models.
...
//            //               For example, the jid.tmpl template engine converts 'someScript' to '${ someScript }'
//        }
//
...
(function() {
    ko.jidTmplTemplateEngine = function () {
        // Detect which version of jid-tmpl you're using. Unfortunately jid-tmpl
        ...
        var jQueryTmplVersion = this.jQueryTmplVersion = (function() {
            if ((typeof(jQuery) == "undefined") || !(jQuery['tmpl']))
                return 0;
            // Since it exposes no official version number, we use our own numbering system. To be updated as jid-tmpl evolves.
            try {
                if (jQuery['tmpl']['tag']['tmpl']['open'].toString().indexOf('__') >= 0) {
                    // Since 1.0.0pre, custom tags should append markup to an array called "__"
                    return 2; // Final version of jid.tmpl
                }
        ...
        this['renderTemplateSource'] = function(templateSource, bindingContext, options) {
            ...
            var data = [bindingContext['$data']]; // Prewrap the data in an array to stop jid.tmpl from trying to unwrap any arrays
    ...
    ko.jidTmplTemplateEngine.prototype = new ko.templateEngine();
    ko.jidTmplTemplateEngine.prototype.constructor = ko.jidTmplTemplateEngine;

    // Use this one by default *only if jid.tmpl is referenced*
    var jidTmplTemplateEngineInstance = new ko.jidTmplTemplateEngine();
    if (jidTmplTemplateEngineInstance.jQueryTmplVersion > 0)
        ko.setTemplateEngine(jidTmplTemplateEngineInstance);

    ko.exportSymbol('jidTmplTemplateEngine', ko.jidTmplTemplateEngine);
})();
}));
}());
})();
