...
namespace ERPKeeper.Helpers
{
    public static class Badge
    {
        ...
        {
            if (content > 60)
                return ERPKeeper.Helpers.Badge.Danger(content);
            if (content > 30)
                return ERPKeeper.Helpers.Badge.Warning(content);
            else 
                return ERPKeeper.Helpers.Badge.Dark(content);
        }
    }
}
