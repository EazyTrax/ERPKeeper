...
namespace ERPKeeper.Node.DAL.Transactions
{
    ...
    public class Sales : Commercials
    {
        ...
        public new Sale Find(Guid transactionUid) => erpNodeDBContext.Sales.Find(transactionUid);
        ...
        public List<Commercial> FindList(Guid id) => this.erpNodeDBContext.Commercials.Where(tr => tr.Uid == id).Take(1).ToList();

        public Sale UpdateChanges(Sale sale)
        {
            var existSale = erpNodeDBContext.Sales.Find(sale.Uid);
        ...
        public void UnPost(Sale sale)
        {
            ...
            else
            {
                ...
                organization.LedgersDal.RemoveTransaction(sale.Uid);
