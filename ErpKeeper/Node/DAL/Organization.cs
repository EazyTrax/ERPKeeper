...
namespace ERPKeeper.Node.DAL
{
    ...
    {
        public ERPDbContext ErpNodeDBContext { get; private set; }
        ...
        private DAL.Accounting.PreviewAccounts _PreviewAccounts;
        ...
        private DAL.Items.DataSheets _DataSheets;
        ...
        public DAL.Accounting.Journals _Journals;
        ...
        private DAL.Projects.Tasks _Tasks;
        ...
        private DAL.Financial.RetentionGroups _RetentionGroups;
        ...
        private DAL.Assets.RetirementFixedAssets _RetirementFixedAssets;
        ...
        public DAL.Accounting.PreviewAccounts PreviewAccounts
        {
            get
            {
        ...
        public DAL.Items.DataSheets DataSheets
        {
            get
            {
        ...
        public DAL.Accounting.Journals Journals
        {
            get
            {
                if (this._Journals == null)
                    this._Journals = new Accounting.Journals(this);
                return _Journals;
            }
        }
        ...
        public DAL.Financial.RetentionGroups RetentionGroups
        {
            get
            {
                if (this._RetentionGroups == null)
                    this._RetentionGroups = new Financial.RetentionGroups(this);
                return _RetentionGroups;
            }
        }
        ...
        public DAL.Accounting.JournalEntryTypes JournalEntryTypes
        {
            get
            {
        ...
        public DAL.Assets.RetirementFixedAssets RetirementFixedAssets
        {
            get
            {
                if (this._RetirementFixedAssets == null)
                    this._RetirementFixedAssets = new Assets.RetirementFixedAssets(this);
                return _RetirementFixedAssets;
            }
        }
        ...
        public Organization(string dbName = "tec", bool migratedDB = false)
        {
            dbName = dbName.ToLower().Replace(".advancemaker.com", "");
            this.DatabaseName = dbName;
            this.ErpNodeDBContext = new ERPDbContext(dbName, migratedDB);
        ...
        public DateTime FirstDate => this.ErpNodeDBContext.FiscalYears.OrderBy(fy => fy.StartDate).FirstOrDefault()?.StartDate ?? new DateTime(DateTime.Now.Year, 1, 1);
